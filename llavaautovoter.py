...
#################################
MODEL_LIST = ["BLIP2", "INSTRUCT_BLIP", "GIT", "KOSMOS2", "VILT"]

##################
# Load ELO class #
##################
elo_system = EloRatingSystem(elo_csv_path="output/llavaautoelo.csv")
...
template = "<image>\nUSER: Choose between (A/B/Tie) Which answer is better for this image and a corresponding question? Question: {} A: {} B: {} \nASSISTANT:\n"
...
for i in range(10000):
    ...
    vote = processor.batch_decode(generated_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False)[0]
    vote = vote.split('\n')[-1]
    if 'Answer :' in vote:
        vote = vote[len('Answer: '):]
    print('DEBUG:', vote)
