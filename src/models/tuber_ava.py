...
from src.models.transformer.util import box_ops
...
from src.models.backbone_builder import build_backbone
from src.models.detr.segmentation import (dice_loss, sigmoid_focal_loss)
from src.models.transformer.transformer import build_transformer
from src.models.transformer.transformer_layers import TransformerEncoderLayer, TransformerEncoder
from src.models.criterion import SetCriterion, PostProcess, SetCriterionAVA, PostProcessAVA, MLP
...
def build_model(cfg):
    if cfg.CONFIG.DATA.DATASET_NAME == 'ava':
        from src.models.detr.matcher import build_matcher
    else:
        from src.models.detr.matcher_ucf import build_matcher
