...
#################################
MODEL_LIST = ["BLIP2", "INSTRUCT_BLIP", "LLAVA", "KOSMOS2", "VILT"]

##################
# Load ELO class #
##################
elo_system = EloRatingSystem(elo_csv_path="output/gitautoelo.csv")
...
for i in range(10000):
    ...
    generated_ids = model.generate(pixel_values=pixel_values, input_ids=input_ids, max_length=200)
    vote = processor.batch_decode(generated_ids, skip_special_tokens=True)[0][len(prompt)+1:]
    print('DEBUG:', vote)
