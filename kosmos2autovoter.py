...
#################################
MODEL_LIST = ["BLIP2", "INSTRUCT_BLIP", "LLAVA", "GIT", "VILT"]

##################
# Load ELO class #
##################
elo_system = EloRatingSystem(elo_csv_path="output/kosmos2autoelo.csv")
...
for i in range(10000):
    ...
    vote, _ = processor.post_process_generation(generated_text)
    vote = vote
    print('DEBUG:', vote)
